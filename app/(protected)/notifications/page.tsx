...
const notifications = [
  ...
  {
    text: 'Ayesha Khan offered help on "Need help"',
    type: "Match",
    time: "Just now",
    unread: true,
  },
  {
    text: 'Your request "Need help" is now live in the community feed',
    type: "Request",
    time: "Just now",
    unread: true,
  },
  {
    text: '"Need help making my portfolio responsive before demo day" was marked as solved',
    type: "Status",
    time: "Just now",
    unread: true,
  },
  {
    text: "New helper matched to your responsive portfolio request",
    type: "Match",
    time: "12 min ago",
    unread: true,
  },
          ...
          <div className="premium-card p-12">
            ...
            <div className="flex flex-col gap-3">
              {notifications.map((notif, i) => (
                <div
                  key={i}
                  className="p-6 rounded-[1.5rem] bg-bg-card border border-black/5 hover:bg-white hover:shadow-lg transition-all cursor-pointer flex items-center justify-between group"
                >
                  ...
                  <div
                    className={`px-4 py-1.5 rounded-full text-[10px] font-bold uppercase tracking-widest ${notif.unread ? "bg-primary text-white shadow-md shadow-primary/20" : "bg-white text-text-muted opacity-40"}`}
                  >
